...
If you do not want to download the full SDK, you can alternatively use the partial solutions Axon Ivy PDF, [Axon Ivy Words](https://market.axonivy.com/axonivy-words?version=13.2.0#description) or [Axon Ivy Cells](https://market.axonivy.com/axonivy-cells?version=13.2.0#description).
